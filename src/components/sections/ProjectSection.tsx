...
const projects = [
  ...
  },
  {
    ...
    tags: ["Web App", "2026"],
    description:
      "Silaju Perumahan is a web application for managing residential data",
    ...
    <section id="projek" className="relative py-20 sm:py-28">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <div className="relative w-full max-w-6xl max-h-[90vh] overflow-y-auto rounded-[2rem] border-2 border-ink bg-cream p-6 sm:p-10 shadow-[8px_8px_0_var(--ink)] animate-in fade-in zoom-in-95 duration-200">
            <button
              onClick={() => setIsModalOpen(false)}
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 sm:p-6">
          ...
          <div className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-[2rem] border-2 border-ink bg-cream p-6 sm:p-8 shadow-[8px_8px_0_var(--ink)] animate-in fade-in zoom-in-95 duration-200">
            <button
              onClick={() => setSelectedProject(null)}
              className="cursor-pointer absolute right-4 top-4 sm:right-6 sm:top-6 grid size-10 place-items-center rounded-xl border-2 border-ink bg-card shadow-[2px_2px_0_var(--ink)] transition-transform hover:-translate-y-0.5"
